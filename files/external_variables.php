...
$external_variables = array(
    "landing.view.background.bottom.left" => "files/images/landing/bottom_left_xmas16.gif",
    "landing.view.background.bottom.right" => "files/images/landing/bottom_right_xmas16.gif",
